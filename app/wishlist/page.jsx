...
//                                             <img
//                                                 className="hidden lg:block w-full h-64 object-cover"
...
//                                             />
//                                             <img
//                                                 className="hidden sm:block lg:hidden w-full h-64 object-cover"
//                                                 src={productImages[0] || '/placeholder-image.jpg'}
//                                                 alt={productName}
//                                                 onError={(e) => {
//                                                     e.target.src = '/placeholder-image.jpg';
...
//                                             />
//                                             <img
//                                                 className="sm:hidden w-full h-64 object-cover"
//                                                 src={productImages[0] || '/placeholder-image.jpg'}
//                                                 alt={productName}
//                                                 onError={(e) => {
//                                                     e.target.src = '/placeholder-image.jpg';
...
//                                                 className="top-4 right-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 absolute p-1.5 bg-gray-800 text-white hover:text-gray-400 transition-colors"
//                                             >
...
//                                                     className="hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 py-2.5 px-2 bg-gray-800 text-white hover:text-gray-400"
//                                                 >
...
//
//                                         {/* Product Details */}
//                                         <div className={`flex-col justify-start items-start mt-12 ${show1 ? "flex mb-4" : "hidden"}`}>
//                                             {/* Tagline */}
//                                             <div>
...
//                                                     {productData?.colors?.[0] || 'Various colors'}
//                                                 </p>
//                                             </div>
//
//                                             <div className="mt-6">
...
//                                                         className="block text-center focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2 text-gray-800 w-full tracking-tight py-4 text-lg leading-4 hover:bg-gray-300 hover:text-gray-800 bg-white border border-gray-800 transition-colors"
//                                                     >
//                                                         More information
//                                                     </Link>
//                                                 </div>
...
//                                                         className="focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2 text-white w-full tracking-tight py-4 text-lg leading-4 hover:bg-black bg-gray-800 border border-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
//                                                     >
//                                                         {wishlistState.loading ? 'Adding...' : 'Add to Cart'}
//                                                     </button>
//                                                 </div>
//                                             </div>
//                                         </div>
