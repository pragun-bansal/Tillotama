...
const Footer: React.FC = () => {
    return (
        <div className="bg-lightpink h-[40vh] mt-[5%]">
            <footer>
                <div className="mx-auto w-full max-w-screen-xl">
                    ...
                    <div className="px-4 py-6 bg-pink md:flex md:items-center md:justify-between">
            <span className="text-sm text-black sm:text-center">
              © 2023{' '}
                <a href="https://tilottama.netlify.app/">TillotamaByArchana™</a>. All Rights Reserved.
            </span>
                        <div className="flex mt-4 space-x-5 sm:justify-center md:mt-0">
                            <ul className="flex">
                                <li>
                                    ...
                                    >
                                        <svg
                                            className="h-[4vh] lg:h-[6vh] p-2 pr-4 fill-white"
