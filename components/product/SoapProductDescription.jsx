// File: components/product/SoapProductDescription.jsx
"use client";
...
import { useAppDispatch, useAuth, useCartOperations, useWishlistOperations } from '@/hooks/redux';
...
const SoapProductDescription = ({ product }) => {
    ...
    // Soap sizes (you can make this dynamic based on product data)
    const soapSizes = ['100gm', '200gm', '300gm'];
        ...
        <div>
            ...
            <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
                ...
                <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6 md:overflow-y-auto md:h-[70vh] xl:h-[100vh]">
                    ...
                    {/* Size Selection */}
                    <div onClick={() => setShowSize(!showSize)} className="py-4 border-b border-gray-200 flex items-center justify-between cursor-pointer">
                        <p className="text-base leading-4 text-gray-800">Size</p>
                        <div className="flex items-center justify-center">
                            <p className="text-sm leading-none text-gray-600 mr-3">Available Sizes</p>
                            <button
                    ...
                    {/* Size Options */}
                    <div className={`pt-4 text-base leading-normal pr-12 mb-4 text-gray-600 ${showSize ? "block" : "hidden"}`}>
                        <ol className="flex flex-wrap gap-2">
                            {soapSizes.map((size, index) => (
                                <li key={index}>
                                    <button className="inline-block hover:bg-slate-300 bg-slate-200 p-4 rounded-md transition-colors">
                                        {size}
                                    </button>
                                </li>
                            ))}
